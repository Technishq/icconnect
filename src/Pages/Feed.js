...
const Feed = () => {
  ...
  const getUserInfo = async () => {
    ...
    setUserInfo({
      ...
      headline: data.user.headline || "Hi! testing if this works",
  ...
  return (
    <Container id="feed-container">
      ...
      {feed.show === "Connections" && <Network userUpdate={getUserInfo} />}
      {feed.show === "explore" && <Explore userUpdate={getUserInfo} />}
